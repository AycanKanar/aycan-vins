...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20_sansplomb_d32cf02c4a6fb9da7110_20220314152116_archive.zip';
	const ARCHIVE_SIZE		 = '102332999';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = 'd32cf02-14152116';
    const SECONDARY_PACKAGE_HASH = '35092e6-14152116';
	const VERSION			 = '1.4.4';
